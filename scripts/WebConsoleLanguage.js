	...
	switch(locale){
		case "en_US":
			lang = {
				...
				"settingsModalLongTitle": "WebConsole Client Settings",
		...
		case "es_ES":
			lang = {
				...
				"settingsModalLongTitle": "Configuración de WebConsole Client",
		...
		case "ru_RU": //Credit to Stashenko
			lang = {
				...
				"settingsModalLongTitle": "настройки WebConsole Client",
		...
		case "pt_BR": //Credit to AlexandreMuassab
			lang = {
				...
				"settingsModalLongTitle": "Configurações do WebConsole Client",
		...
		case "zh_CN": //Credit to Neubulae
			lang = {
				...
				"addServerModalSvPort": "WebConsole 端口:",
				...
				"settingsLink": "设定值",
				"settingsModalLongTitle": "WebConsole Client 设定值",
		...
		case "ko_KR":
			lang = {
				...
				"settingsLink": "설정",
				"settingsModalLongTitle": "WebConsole Client 설정",
		...
		case "fr_FR":
			lang = {
				...
				"settingsModalLongTitle": "Réglages de WebConsole Client",
		...
		case "cs_CZ":
			lang = {
				...
				"settingsModalLongTitle": "Nastavení WebConsole Client",
		...
		case "it_IT": //Credit to AlexZap
			lang = {
				...
				"settingsModalLongTitle": "Impostazioni WebConsole Client",
		...
		case "nl_NL": //Credit to Twockx
			lang = {
				...
				"settingsModalLongTitle": "WebConsole Client Instellingen",
		...
		case "de_DE": //Credit to NoNamePro0
			lang = {
				...
				"settingsModalLongTitle": "WebConsole Client Einstellungen",
		...
		case "tr_TR": //Credit to acarnd03
			lang = {
				...
				"settingsModalLongTitle": "WebConsole Client Ayarları",
		...
		case "ja_JA": //Credit to kuroneko6423 | https://kuroneko6423.com
			lang = {
				...
				"settingsLink": "設定",
				"settingsModalLongTitle": "WebConsole Client 設定",
		...
		case "pl_PL": //Credit to gpewojan1
			lang = {
				...
				"settingsModalLongTitle": "Ustawienia WebConsole Client",
